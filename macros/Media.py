...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        (0x000000, '', []),
        # 2nd row ----------
        (0x050500, 'Vol-', [[ConsumerControlCode.VOLUME_DECREMENT]]),
        (0x050000, 'Mute', [[ConsumerControlCode.MUTE]]),
        (0x000500, 'Vol+', [[ConsumerControlCode.VOLUME_INCREMENT]]),
        # 3rd row ----------
        (0x000000, '', []),
        (0x000000, '', []),
        (0x000000, '', []),
        # 4th row ----------
        (0x050500, '<<', [[ConsumerControlCode.SCAN_PREVIOUS_TRACK]]),
        (0x050000, 'Play/Pause', [[ConsumerControlCode.PLAY_PAUSE]]),
        (0x000500, '>>', [[ConsumerControlCode.SCAN_NEXT_TRACK]]),
        # Encoder button ---
        (0x000000, '', []),
        ],
