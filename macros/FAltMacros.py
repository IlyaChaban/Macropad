...
app = {               # REQUIRED dict, must be named 'app'
    'name' : 'Alt+F macros', # Application name
    'macros' : [      # List of button macros...
        # COLOR    LABEL    KEY SEQUENCE
        # 1st row ----------
        (0x000500, 'Alt+F13', [Keycode.ALT, Keycode.F13]),
        (0x000500, 'Alt+F14', [Keycode.ALT, Keycode.F14]),
        (0x000500, 'Alt+F15', [Keycode.ALT, Keycode.F15]),
        # 2nd row ----------
        (0x000500, 'Alt+F16', [Keycode.ALT, Keycode.F16]),
        (0x000500, 'Alt+F17', [Keycode.ALT, Keycode.F17]),
        (0x000500, 'Alt+F18', [Keycode.ALT, Keycode.F18]),
        # 3rd row ----------
        (0x000500, 'Alt+F19', [Keycode.ALT, Keycode.F19]),
        (0x000500, 'Alt+F20', [Keycode.ALT, Keycode.F20]),
        (0x000500, 'Alt+F21', [Keycode.ALT, Keycode.F21]),
        # 4th row ----------
        (0x000500, 'Alt+F22', [Keycode.ALT, Keycode.F22]),
        (0x000500, 'Alt+F23', [Keycode.ALT, Keycode.F23]),
        (0x000500, 'Alt+F24', [Keycode.ALT, Keycode.F24]),
        # Encoder button ---
        (0x000000, '', [])
        ],
    
    'icons' : 'AltF_macros.bmp'
}
